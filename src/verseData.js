...
export const VERSES = [
  ...
  },
  {
    ...
    game: '挪亞蓋方舟', enter: 'https://hfpc-paul-game.pages.dev/?demo=ark-build',
  },
  {
    ...
    game: '約沙法唱詩得勝', enter: 'https://hfpc-paul-game.pages.dev/?demo=jehoshaphat',
  },
  {
    ...
    game: '紅海奔逃', enter: 'https://hfpc-paul-game.pages.dev/?demo=redsea',
  },
  {
  ...
  },
  {
    ...
    game: '哥尼流', enter: 'https://hfpc-paul-game.pages.dev/?demo=cornelius',
  },
  {
    id: 'acts-9-saul', book: '使徒行傳', ref: '使徒行傳 9:4', status: 'live',
    theme: '主的光照亮逼迫者,生命可以一夕翻轉。',
    text: '掃羅！掃羅！你為甚麼逼迫我？', cuv: 'verified',
    game: '掃羅歸主', enter: 'https://hfpc-paul-game.pages.dev/?demo=saul',
  },
  {
    ...
    game: '但以理(金像/牆上字/神掌權)', enter: 'https://hfpc-paul-game.pages.dev/',
  },
  {
...

  {
    ...
    game: '約瑟的彩衣', enter: 'https://hfpc-paul-game.pages.dev/?demo=joseph',
  },
  {
    ...
    game: '撒母耳聽呼喚', enter: 'https://hfpc-paul-game.pages.dev/?demo=samuel',
  },
  {
    ...
    game: '好牧人尋羊', enter: 'https://hfpc-paul-game.pages.dev/?demo=shepherd',
  },
  {
    ...
    game: '路得記·從空到滿', enter: 'https://hfpc-ruth-game.pages.dev/',
  },
