...
- **現況:24 張首頁卡、7 個合輯(37 關)、sw v18**。07-06 新增:🕯️ 撒母耳聽呼喚卡(paul ?demo=samuel,PR #64 併入、牧者過審)+ 金句 撒上 3:10(verseData 20 句)。ruth 的 Netlify 已接 GitHub(07-05 深夜),線上為新版;路得卡與 ruth-1-16 金句照常。
- 07-05 曾新增:🐑 好牧人尋羊卡、🧩 拼金句分頁、戰爭三卡改指 paul——**hfpc-war-games 可退役**(等使用者定)。
- 🔜 下一張卡:約瑟彩衣滑塊拼圖(新類型③,做完+過審後)。
