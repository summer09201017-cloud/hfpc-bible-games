...
## 🎯 當前任務(最高優先):逆轉奇兵兒童營
- **五奇兵**:聖歌(約沙法)/福音(哥尼流)/反轉(巴蘭)/盼望(以利亞)/大光(掃羅),每個**卡片版 + 動作版** = 共 10 張卡,目標把這 10 張收完、文案審完、卡片點亮。
- ⛔ **別「開新書卷」**(路得 / 以斯帖 / 約瑟…)——一律「營會後」再說,別排進任務、別分心。
- ✅ 註:**紅海奔逃已做好**(`?demo=redsea` 動作關,僅待 paul 部署),**不是待辦、別重做**。(早期提案誤寫「別碰紅海」,已更正。)
